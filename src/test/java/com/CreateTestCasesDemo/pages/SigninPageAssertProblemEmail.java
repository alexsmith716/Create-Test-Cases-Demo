...
// Test scenario: Submit incorrect/malformed/problem email input data and verify/assert the failed sign-in.
// Example input generates same response: "problemEmail", "problemEmail@problemEmail.com"

public class SigninPageAssertProblemEmail extends BasePage {
	private String title;
	private boolean signinProblemAlert;
	private String aAlertHeadingText;
	private String aListItemText;
  private String signInEmailMobilePhone = "problemEmail";
	...
	public void signinAssertProblemEmail() throws Exception {
